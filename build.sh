...
FILES="README.md LICENSE .gitignore build.sh bridge.py cfi.py txt.py run.sh trigger.sh event_patch.py settings_patch.py notify.py notify-ui.js install.sh uninstall.sh config.example.json test/test_config.py test/test_cfi.py test/test_txt.py test/test_e2e_txt.py"
